...
async def async_setup_entry(
    ...
    temperature_sensors = [
        ...
        (
            ...
            "Room Temperature Comfort Plus",
            "room_temperature_comfort_plus",
        ),
        (
            "room_temperature_comfort_minus",
            "Room Temperature Comfort Minus",
            "room_temperature_comfort_minus",
        ),
        (
            "cwu_temperature_economy",
            "CWU Temperature Economy",
            "cwu_temperature_economy",
        ),
        (
            "cwu_temperature_comfort",
            "CWU Temperature Comfort",
            "cwu_temperature_comfort",
        ),
        ("manual_temperature", "Manual Temperature", "manual_temperature"),
    ]

    for unique_id, name, setting_name in temperature_sensors:
        entities.append(
            KospelTemperatureSensor(
                coordinator, entry.entry_id, unique_id, name, setting_name
            )
        )
    ...
    entities.append(
        KospelPumpStatusSensor(
            coordinator, entry.entry_id, "pump_co", "Pump CO", "is_pump_co_running"
        )
    )
    entities.append(
        KospelPumpStatusSensor(
...
class KospelTemperatureSensor(KospelSensorEntity):
    ...
    def __init__(
        ...
        super().__init__(coordinator, entry_id, unique_id_suffix, name)
...
class KospelValvePositionSensor(KospelSensorEntity):
    ...
    def __init__(
        ...
        super().__init__(coordinator, entry_id, "valve_position", "Valve Position")
